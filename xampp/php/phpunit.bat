...
if "%PHPBIN%" == "" set PHPBIN=C:\Users\Revox\Desktop\Winf_Chatbot\Winf_Chatbot\xampp\php\.\php.exe
if not exist "%PHPBIN%" if "%PHP_PEAR_PHP_BIN%" neq "" goto USE_PEAR_PATH
GOTO RUN
:USE_PEAR_PATH
set PHPBIN=%PHP_PEAR_PHP_BIN%
:RUN
"%PHPBIN%" "C:\Users\Revox\Desktop\Winf_Chatbot\Winf_Chatbot\xampp\php\phpunit" %*
